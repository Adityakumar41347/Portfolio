  ...
  return (
    <div className={`${mode ? "bg-zinc-900 text-gray-300" : "bg-white text-gray-900"} min-h-screen`}>
      <div className="container mx-auto md:p-10 p-4 md:w-[70%]">
        ...
        Follow links- <Link className="hover:underline text-blue-600 " href={"https://leetcode.com/u/aditya_kumar_41347/"} target="_blank">Leetcode</Link>, <Link className="hover:underline text-blue-600" href={"https://www.geeksforgeeks.org/user/adityakum2l0f/"} target="_blank">GfG</Link>
